...
| **[command](#command)**             | String  |         | Command to be performed when the build process finishes |
...
There are some applications that require a command to be started. This property allows you to perform any command you want after the build process.
